...
import useLoad from "../../Hook/useLoading";
        ...
        <div className={style.ContainerAbout}>
          ...
          <div className={style.containerPresentationAbout}>
            ...
            <div className={style.infoPresentationAbout}>
              ...
              <p className={style.infAbout}>
                👋 Mi nombre es Nolger luis Rodríguez Medina. Pero usted me
                puede llamar Nolger. ¡Un pacer!
              </p>
              <p className={style.infAbout}>
                💻 Llevo más de 3 años diseñando y desarrollando interfaces con
                JavaScript, React JS y TypeScript.
              </p>
              <p className={style.infAbout}>
                📚 Actualmente estudio ingeniería de sistemas en la universidad
                de la Guajira.
              </p>
              <p className={style.infAbout}>
                💡 Estoy interesado en el desarrollo FullStack con React, React
                Native, Java Script, Type Script, Python, MySql.
              </p>
              <p className={style.infAbout}>
                🛸 Tratando de ser un poquito mejor día tras día.
              </p>
            </div>
          </div>
        </div>
